...
<head>
    ...
    <title>成都市中小微企业运行情况分析系统 - 数据导入 - 楼宇数据更新</title>
    ...
    <div class="main-container-inner">
        ...
        <div class="main-content">
            <div class="page-content">
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div>
                                        <h5>楼宇数据更新表模板，请<a href="${basePath}/tableDownload/楼宇数据更新表.xls">点击下载。</a></h5>
                                    </div>
                                    <hr>
                                    <h4>上传记录</h4>
                                    <table id="tb"> </table>
                ...
                <%--<div class="row">--%>
                    <%--<div class="col-xs-12">--%>
                        <%--<div class="col-xs-12 form-group" style="padding: 10px 0 0 0">--%>
                            ...
                            <%--<a href="${basePath}/tableDownload/楼宇数据更新表.xls">--%>
                            <%--<h4>下载“楼宇数据更新表”模板</h4>--%>
                            <%--</a>--%>
                        <%--</div>--%>
                        <%--<hr>--%>
                        <%--&lt;%&ndash;<h2>数据格式示例</h2>&ndash;%&gt;--%>
                        <%--<img src="${basePath}/static/images/buildingFormatExample.png" style="width: 1000px;height: 50px">--%>
                        <%--&lt;%&ndash;<h5>说明：多个企业注册号以逗号隔开</h5>&ndash;%&gt;--%>
                        <%--<h2>上传记录</h2>--%>
                        <%--<br>--%>
                        <%--<table id="tb"> </table>--%>
...
<script src="${basePath}/static/js/dataImport/buildingDataUpdates.js"></script>
