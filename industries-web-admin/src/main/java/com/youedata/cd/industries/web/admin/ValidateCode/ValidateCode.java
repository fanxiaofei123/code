package com.youedata.cd.industries.web.admin.ValidateCode;
...
public class ValidateCode {
	...
	public void getRandCode(HttpServletRequest request, HttpServletResponse response)
		...
		// 将认证码存入SESSION
		request.getSession().setAttribute("randomCode", resultCode);
		// 图象生效
		graphics.dispose();
...
enum RandCodeImageEnum {
	 ...
	 * 混合字符串
	 */
	ALL_CHAR("123456789abcdefghijkmnpqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ"), // 去除小写的l和o这个两个不容易区分的字符；
	/**
	 * 字符
	 */
	LETTER_CHAR("abcdefghijklmnpqrstuvwxyzABCDEFGHIJKLMNPQRSTUVWXYZ"),
	/**
	 * 小写字母
	 */
	LOWER_CHAR("abcdefghijklmnpqrstuvwxyz"),
	/**
	 * 数字
	 */
	 ...
	 * 大写字符
	 */
	UPPER_CHAR("ABCDEFGHIJKLMNPQRSTUVWXYZ");
	/**
	 * 待生成的字符串
	 */
